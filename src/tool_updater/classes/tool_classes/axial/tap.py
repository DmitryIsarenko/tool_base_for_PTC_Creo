...
class Drill(BaseTool):
    ...
    def get_chamfer_length(self):
        ...
        pitch =self.catalog_tool_geometry[self.tool_size_from_geom_catalogue]["thread_pitch"]
    ...
    <ToolingSetup>
        <Tool Id="{self.tool_data["tool_name_for_xml"]}" RefXmlId="encref_1" Type="{self.tool_data["tool_type"]}">
            ...
            <MfgParam Name="POINT_DIAMETER" Value="{self.get_point_diameter}"/>            

            <MfgParam Name="CHAMFER_LENGTH" Value="{self.get_chamfer_length}"/>
